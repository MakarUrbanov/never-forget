...
extension MainFlowCoordinator {
  ...
  private func getMainCoordinator() -> MainScreenCoordinator {
    ...
    mainScreenCoordinator.navigationController.tabBarItem = UITabBarItem(title: Localizable.Tabs.main.toString(),
...
extension MainFlowCoordinator {
  ...
  private func getPeopleListCoordinator() -> PeopleListCoordinator {
    ...
    peopleListCoordinator.navigationController.tabBarItem = UITabBarItem(title: Localizable.Tabs.list.toString(),
